...
print color("blue"),"                                                                                                      -> Shashank Shekhar \n", color("reset");
print color("blue"),"	                                                                                                   -> shashankshekhar1337protonmail.com\n", color("reset");
START:
...
{
print "\n";
print "Port Scanning Attack Detector Started------------------------ OK \n";
...
print "\n";
print color("yellow"),"1 = Check For Ddos Attack \n", color("reset");
...
system('sudo bash /root/Desktop/ids/ddosdetect.sh');
print "\n";
goto START4;
}
elsif($dos eq "2")
...
system('sudo bash /root/Desktop/ids/Ddos/ddosdetect.sh');
print "\n";
goto START4;
}
elsif($dos eq "3")
